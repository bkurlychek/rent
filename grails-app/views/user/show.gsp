	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.asset}">
				<li class="fieldcontain">
					<span id="asset-label" class="property-label"><g:message code="user.asset.label" default="Asset" /></span>
					
						<g:each in="${userInstance.asset}" var="a">
						<span class="property-value" aria-labelledby="asset-label"><g:link controller="property" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></span>
						</g:each>
